...
import { SignIn, SignOut } from "../../AuthBtns/AuthBtns";
...
export default function UserDialog({ sesh }: {
    ...
    return (
        <>
            <button className={styles['btn']} onPointerDown={() => setIsOpen(true)}>
                <Avatar username={user.username || '404'} userId={user.id} image={user.image} />
            </button>
            <ModalSlide isOpen={isOpen} setIsOpen={setIsOpen}>
                ...
                <hr />
                {/* Add? Might take too much time... */}
                <div className='modalSlideSect'>
                    <h1>Ai buddy</h1>
